...
(function (global, factory) {
    ...
    var ValidatorRegistry__operatorToValidator = function ValidatorRegistry__operatorToValidator(
        ...
        return function (value) {
            ...
            return operator.apply(
                ...
                [value].concat(
                    _toConsumableArray(
                        ValidatorRegistry__parseArguments(
                            type,
    ...
    var ValidatorRegistry__comparisonOperator = function ValidatorRegistry__comparisonOperator(
        ...
        return {
            ...
            requirementType:
                operator.length <= 2 ? "string" : ["string", "string"], // Support operators with a 1 or 2 requirement(s)
            priority: 30,
        };
    };
    ...
    Form.prototype = {
        ...
        _submit: function _submit(submitSource) {
            ...
            this.$element.trigger(
                _extends($.Event("submit"), { parsley: true })
            );
        },
        ...
        _bindFields: function _bindFields() {
            ...
            this._withoutReactualizingFormOptions(function () {
                _this8.$element
                    ...
                    .each(function (_, element) {
                        ...
                        if (
                            ...
                            if (
                                "undefined" ===
                                typeof _this8.fieldsMappedById[uniqueId]
                            ) {
                                _this8.fieldsMappedById[
                                    uniqueId
                                ] = fieldInstance;
                ...
                $.each(
                    Utils.difference(oldFields, _this8.fields),
                    function (_, field) {
                        field.reset();
                    }
                );
